...
describe("RunControls", () => {
  ...
  beforeEach(() => {
    ...
    mockPauseRunResult.mockResolvedValue({ data: { id: "run-1", status: "paused" } });
    mockResumeRunResult.mockResolvedValue({ data: { id: "run-1", status: "running" } });
    mockRestoreAllRunsResult.mockResolvedValue({ data: [] });
  });
