...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("home_location_id", sa.String(length=64), sa.ForeignKey("locations.id"), nullable=True),
        sa.Column("current_location_id", sa.String(length=64), sa.ForeignKey("locations.id"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("actor_agent_id", sa.String(length=64), sa.ForeignKey("agents.id"), nullable=True),
        sa.Column("target_agent_id", sa.String(length=64), sa.ForeignKey("agents.id"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("other_agent_id", sa.String(length=64), sa.ForeignKey("agents.id"), nullable=False),
